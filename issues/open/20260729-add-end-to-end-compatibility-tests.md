...
4. Cover non-streaming and streaming responses, tool use/tool result round trips, system prompts, valid image forwarding, malformed or unsupported media rejection, client disconnect, upstream errors, and malformed upstream frames.
